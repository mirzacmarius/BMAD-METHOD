...
- The `orchestrator-agent/templates/story-tmpl.md` (hereafter "Story Template")
- The `orchestrator-agent/checklists/story-draft-checklist.md` (hereafter "Story Draft Checklist")
